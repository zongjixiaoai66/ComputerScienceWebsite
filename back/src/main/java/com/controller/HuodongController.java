    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(huodong !=null){
            ...
            BeanUtils.copyProperties( huodong , view );//把实体数据重构到view中
                ...
                //级联表
                YonghuEntity yonghu = yonghuService.selectById(huodong.getYonghuId());
                if(yonghu != null){
    ...
    */
    ...
    public R save(@RequestBody HuodongEntity huodong, HttpServletRequest request){
        ...
        if(false)
            ...
            huodong.setYonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));

        Wrapper<HuodongEntity> queryWrapper = new EntityWrapper<HuodongEntity>()
            .eq("yonghu_id", huodong.getYonghuId())
...
//                            huodongEntity.setYonghuId(Integer.valueOf(data.get(0)));   //校友 要改的
