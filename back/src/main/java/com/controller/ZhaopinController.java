    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(zhaopin !=null){
            ...
            BeanUtils.copyProperties( zhaopin , view );//把实体数据重构到view中
                ...
                //级联表
                YonghuEntity yonghu = yonghuService.selectById(zhaopin.getYonghuId());
                if(yonghu != null){
    ...
    */
    ...
    public R save(@RequestBody ZhaopinEntity zhaopin, HttpServletRequest request){
        ...
        if(false)
            ...
            zhaopin.setYonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));

        Wrapper<ZhaopinEntity> queryWrapper = new EntityWrapper<ZhaopinEntity>()
            .eq("yonghu_id", zhaopin.getYonghuId())
...
//                            zhaopinEntity.setYonghuId(Integer.valueOf(data.get(0)));   //校友 要改的
